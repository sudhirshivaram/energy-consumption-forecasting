...
class ModelFactory:
    ...
    Supports LinearRegression, Ridge, Lasso, CatBoost, XGBoost, LightGBM, RandomForest, and GradientBoosting.
    """
    ...
    def create_model(cls, model_type: str, params: Dict[str, Any]) -> Union[
        LinearRegression, Ridge, Lasso, CatBoostRegressor, XGBRegressor, LGBMRegressor, RandomForestRegressor, GradientBoostingRegressor
    ]:
        """
        ...
        if model_type in ['CatBoostRegressor']:
            # Remove fit_intercept if present (not supported)
            params_copy.pop('fit_intercept', None)
